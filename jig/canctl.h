...
static const int cantp_id_map_info[256] = {
    /* CAN-TP ID MAP (0 ~ 127) */
    /* Node A */
...
//#define cantp_id_map(x)     (cantp_id_map_info[#x])

static inline int cantp_id_map(int id) {
    return cantp_id_map_info[id];
}
